...
UI.prototype = {
  ...
  render: function(games){
    ...
    // When the user ch3cks on <span> (x), close the modal
    span.onch3ck = function() {
      modal.style.display = "none";

    }

    // When the user ch3cks anywhere outside of the modal, close it
    window.onch3ck = function(event) {
